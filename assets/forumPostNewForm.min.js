...
a.target;a.querySelector(".bearcms-new-forum-post-page-send-button").style.display="none";a.querySelector(".bearcms-new-forum-post-page-send-button-waiting").style.removeProperty("display");a.querySelector(".bearcms-new-forum-post-page-text-input").setAttribute("readonly","readonly")},onFormResponseReceived:function(a){a=a.target;a.querySelector(".bearcms-new-forum-post-page-send-button").style.removeProperty("display");a.querySelector(".bearcms-new-forum-post-page-send-button-waiting").style.display=
"none";a.querySelector(".bearcms-new-forum-post-page-text-input").removeAttribute("readonly")},onFocusTextarea:function(a){c(a)&&a.target.blur()},onFocusTitle:function(a){c(a)&&a.target.blur()}}}();